 ...
 * 
 * This function registers to receive notifications about leave lobby requests performed by the local user via the overlay. When a user requests to leave the lobby in the social overlay, the SDK does not automatically leave the lobby, it is up to the game to perform any necessary cleanup and call the ${function.eos_lobby_leave_lobby} method using the `lobby_id` sent in the notification function.
 * 
 ...
 * 
 * This function creates a handle to an existing lobby. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsHandle, must be passed to EOS_LobbyDetails_Release to release the memory associated with it.
 * 
 ...
 * 
 * This function is used to immediately retrieve a handle to the lobby information from after notification of an invite. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsHandle, must be passed to EOS_LobbyDetails_Release to release the memory associated with it.
 * 
 * The function returns one of the following:
 * 
 ...
 * 
 * @param {string} InviteId The ID of an invitation to join the lobby
 *
 * @returns {constant.eos_result}
 * 
 * @func_end
 ...
 * 
 * This function is used to immediately retrieve a handle to the lobby information from after notification of an join game. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsHandle, must be passed to EOS_LobbyDetails_Release to release the memory associated with it.
 * 
 * The function returns one of the following:
 * 
 * * EOS_Success if the information is available and passed out in OutLobbyDetailsHandle
 ...
 * @param {string} lobby_id (Optional) Set to a globally unique value to override the backend assignment. If not specified, the backend service will assign one to the lobby. Do not mix and match override and non override settings. This value can be of size [EOS_LOBBY_MIN_LOBBYIDOVERRIDE_LENGTH, EOS_LOBBY_MAX_LOBBYIDOVERRIDE_LENGTH]
 * @param {string} bucket_id Bucket ID associated with the lobby
 * @param {real} max_lobby_members The maximum number of users who can be in the lobby at a time
 ...
 * @param {bool} presence_enabled If `true`, this lobby will be associated with the local user's presence information. A user's presence can only be associated with one lobby at a time. This affects the ability of the Social Overlay to show game related actions to take in the user's social graph. * using the `presence_enabled` flags within the Sessions interface * using the `presence_enabled` flags within the Lobby interface * using ${function.eos_presence_modification_set_join_info} EOS_PresenceModification_SetJoinInfo
 ...
 * @param {flags} flags Flags for the local user in this room. The default is 0 if this struct is not specified. See EOS_RTC_JoinRoomOptions::Flags
 ...
 * 
 * The function returns EOS_Success if the search creation completes successfully, or EOS_InvalidParameters if any of the options are incorrect.
 *
 * @param {real} max_results Maximum number of results allowed from the search
 *
 * @returns {constant.eos_result}
 * 
 * @func_end
 ...
 *
 * @param {bool} hard_mute The targetUserId hard mute status (mute on or off)
 * @param {string} lobby_id The ID of the lobby
 ...
 * 
 * This function parses the ConnectString for an EOS lobby invitation to extract just the lobby ID. Used for joining a lobby from a connection string (as generated by GetConnectString) found in a platform invitation or presence.
 * 
 * @returns {string}
 * 
 * @func_end
 ...
 * 
 * Send an invite to another user. The user must be a member of the lobby or else the call will fail.
 * 
 ...
 * 
 * This function creates a lobby modification handle (EOS_HLobbyModification). The lobby modification handle is used to modify an existing lobby and can be applied with ${function.eos_lobby_update_lobby}. The EOS_HLobbyModification must be released by calling ${function.eos_lobby_modification_release} once it is no longer needed.
 * 
 * The function returns one of the following:
 * 
 * * EOS_Success if EOS successfully created the Lobby Modification Handle, or an error result if the input data was invalid
 * * EOS_InvalidParameters if any of the options are incorrect
 *
 * @param {string} lobby_id The ID of the lobby
 ...
 * @member {constant.EOS_LobbyAttributeVisibility} Whether this attribute is public or private to the lobby and its members
 * 
 * @struct_end
 */
 ...
 * 
 * This function is used to immediately retrieve a copy of lobby information from a given source such as a existing lobby or a search result. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsInfo, must be passed to ${function.eos_lobby_details_info_release} to release the memory associated with it.
 * 
 ...
 * 
 * This function is used to immediately retrieve a copy of a lobby member attribute from an existing lobby. If the call returns an EOS_Success result, the out parameter, OutAttribute, must be passed to EOS_Lobby_Attribute_Release to release the memory associated with it.
 * 
 ...
 * @member {EOS_OnlinePlatformType} platform The platform of the lobby member
 ...
 * 
 * This function is used to immediately retrieve a copy of lobby member information from an existing lobby. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsMemberInfo, must be passed to EOS_LobbyDetails_MemberInfo_Release to release the memory associated with it.
 * 
 * [[Note: this information is only available if you are actively in the lobby. It is not available for search results.]]
 * 
 ...
 * @param {struct} attribute A single key/value pair describing the attribute to add to the lobby
 *
 * @returns {constant.eos_result}
 * 
 * @func_end
 ...
 * @param {struct} attribute A key/value pair describing the attribute to add to the lobby member
 * 
 * @returns {constant.eos_result}
 * 
 * @func_end
 ...
 * 
 * This function is used to immediately retrieve a handle to the lobby information from a given search result. If the call returns an EOS_Success result, the out parameter, OutLobbyDetailsHandle, must be passed to EOS_LobbyDetails_Release to release the memory associated with it.
 * 
 * The function returns one of the following:
 * 
 * * EOS_Success if the information is available and passed out in OutLobbyDetailsHandle
