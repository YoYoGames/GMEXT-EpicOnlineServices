/**
 * @module home
 * @title EpicOnlineServices Extension
 * @desc ![](assets/Logo.jpg)
 * 
 ...
 * See the [official page](https://dev.epicgames.com/docs/services/en-US/index.html) for more documentation.
 * 
 * @section Setup
 ...
 * @ref module.user_info
 * @ref module.general
 * @section_end
 *
 * @section Result Constants
 * @desc This extension API can return a large set of result constants depending on the function being called. See ${constant.EpicResult} for the full list.
 * 
 * @section_end
 * 
 * @module_end
