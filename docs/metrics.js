 ...
 * 
 * @param {string} accountID An Epic Account ID. Set this field when `AccountIdType` is set to `EOS_METRICS_ACCOUNT_ID_TYPE.EPIC`.
 ...
 * @param {constant.EOS_USER_CONTROLLER_TYPE} ControllerType The user's game controller type.
 ...
 * 
 * @param {string} accountID Set this field when `AccountIdType` is set to `EOS_METRICS_ACCOUNT_ID_TYPE.EPIC`
 ...
 * @example
 * ```gml
 * var _struct = eos_metrics_end_player_session(AccountID, EOS_METRICS_ACCOUNT_ID_TYPE.EPIC);
