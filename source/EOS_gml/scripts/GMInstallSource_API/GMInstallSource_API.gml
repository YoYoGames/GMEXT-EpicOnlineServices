...
function install_source_request(_callback)
{
    ...
    var __return_value__ = __install_source_request(buffer_get_address(__args_buffer__), buffer_tell(__args_buffer__));
...
function install_source_get_cached()
{
    ...
    var __return_value__ = __install_source_get_cached(buffer_get_address(__ret_buffer__), buffer_get_size(__ret_buffer__));

    var __result__ = undefined;
    __result__ = buffer_read(__ret_buffer__, buffer_u32);
    return __result__;
}
...
#export InstallSource, install_source_request, install_source_get_cached
