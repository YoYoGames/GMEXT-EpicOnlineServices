...
yyfunc double SDKEpicGames_ActiveSession_CopyInfo(char* SessionName, char* buff_ret)
{
...
yyfunc char* EpicGames_ActiveSession_GetRegisteredPlayerByIndex(char* SessionName)
{ 
	EOS_Sessions_CopyActiveSessionHandleOptions HOptions = {0};
	HOptions.ApiVersion = EOS_SESSIONS_COPYACTIVESESSIONHANDLE_API_LATEST;
	HOptions.SessionName = SessionName;
...
yyfunc double EpicGames_ActiveSession_GetRegisteredPlayerCount(char* SessionName)
{ 
	EOS_Sessions_CopyActiveSessionHandleOptions HOptions = {0};
	HOptions.ApiVersion = EOS_SESSIONS_COPYACTIVESESSIONHANDLE_API_LATEST;
	HOptions.SessionName = SessionName;
...
yyfunc double SDKEpicGames_SessionDetails_CopyInfo(char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_SessionDetails_CopySessionAttributeByIndex(double AttrIndex, char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_SessionDetails_CopySessionAttributeByKey(char* AttrKey,char* buff_ret)
{ 
...
yyfunc double EpicGames_SessionDetails_GetSessionAttributeCount()
{ 
...
yyfunc double EpicGames_SessionDetails_Release()
{ 
...
yyfunc double SDKEpicGames_SessionModification_AddAttribute(double AdvertisementType, double SessionAttribute, char* buff_args)
{ 
...
yyfunc double EpicGames_SessionModification_Release()
{ 
...
yyfunc double EpicGames_SessionModification_RemoveAttribute(char* Key)
{ 
...
yyfunc double SDKEpicGames_SessionModification_SetAllowedPlatformIds(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
...
yyfunc double EpicGames_SessionModification_SetBucketId(char* BucketId)
{ 
...
yyfunc double EpicGames_SessionModification_SetHostAddress(char* HostAddress)
{
...
yyfunc double EpicGames_SessionModification_SetInvitesAllowed(double bInvitesAllowed)
{
...
yyfunc double EpicGames_SessionModification_SetJoinInProgressAllowed(double bAllowJoinInProgress)
{
...
yyfunc double EpicGames_SessionModification_SetMaxPlayers(double MaxPlayers)
{
...
yyfunc double EpicGames_SessionModification_SetPermissionLevel(double PermissionLevel)
{
...
yyfunc double SDKEpicGames_Sessions_AddNotifyJoinSessionAccepted(char* buff_ret)
{
...
yyfunc double SDKEpicGames_Sessions_AddNotifyLeaveSessionRequested(char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_Sessions_AddNotifySendSessionNativeInviteRequested(char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_Sessions_AddNotifySessionInviteAccepted(char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_Sessions_AddNotifySessionInviteReceived(char* buff_ret)
{ 
...
yyfunc double SDKEpicGames_Sessions_AddNotifySessionInviteRejected(char* buff_ret)
{ 
...
yyfunc double EpicGames_Sessions_CopySessionHandleByInviteId(char* InviteId)
{
...
yyfunc double SDKEpicGames_Sessions_CopySessionHandleByUiEventId(char* buff_args)
{
	auto args = buffer_unpack((uint8_t*)buff_args);
...
yyfunc double EpicGames_Sessions_CopySessionHandleForPresence(char* local)
{ 
...
yyfunc double SDKEpicGames_Sessions_CreateSessionModification(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
...
yyfunc double EpicGames_Sessions_CreateSessionSearch(double MaxSearchResults)
{ 
...
yyfunc double EpicGames_Sessions_DestroySession(char* SessionName)
{ 
...
yyfunc double EpicGames_Sessions_DumpSessionState(char* SessionName)
{ 
...
yyfunc double EpicGames_Sessions_EndSession(char* SessionName)
{ 
...
yyfunc double EpicGames_Sessions_GetInviteCount(char* local)
{ 
...
yyfunc char* EpicGames_Sessions_GetInviteIdByIndex(char* local, double index)
{ 
...
yyfunc double EpicGames_Sessions_IsUserInSession(char* SessionName, char* TargetUserId)
{
...
yyfunc double EpicGames_Sessions_JoinSession(double PresenceEnabled, char* LocalUserId, char* SessionName)
{ 
...
yyfunc double EpicGames_Sessions_QueryInvites(char* TargetUserId)
{ 
...
yyfunc double SDKEpicGames_Sessions_RegisterPlayers(char* SessionName, char* buff_args)
{
	auto args = buffer_unpack((uint8_t*)buff_args);
	auto array_ids = YYGetArray(args[0]);
...
yyfunc double EpicGames_Sessions_RejectInvite(char* LocalUserId, char* InviteId)
{ 
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifyJoinSessionAccepted(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifyLeaveSessionRequested(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
	EOS_NotificationId InId = YYGetUint64(args[0]);
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifySendSessionNativeInviteRequested(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
	EOS_NotificationId InId = YYGetUint64(args[0]);
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifySessionInviteAccepted(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
	EOS_NotificationId InId = YYGetUint64(args[0]);
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifySessionInviteReceived(char* buff_args)
{
	auto args = buffer_unpack((uint8_t*)buff_args);
	EOS_NotificationId InId = YYGetUint64(args[0]);
...
yyfunc double SDKEpicGames_Sessions_RemoveNotifySessionInviteRejected(char* buff_args)
{ 
	auto args = buffer_unpack((uint8_t*)buff_args);
	EOS_NotificationId InId = YYGetUint64(args[0]);
...
yyfunc double EpicGames_Sessions_SendInvite(char* LocalUserId, char* SessionName, char* TargetUserId)
{ 
...
yyfunc double EpicGames_Sessions_StartSession(char* SessionName)
{ 
...
yyfunc double SDKEpicGames_Sessions_UnregisterPlayers(char* SessionName, char* buff_args)
{
	auto args = buffer_unpack((uint8_t*)buff_args);
	auto array_ids = YYGetArray(args[0]);
...
yyfunc double EpicGames_Sessions_UpdateSession()
{
...
yyfunc double EpicGames_Sessions_UpdateSessionModification(char* SessionName)
{ 
...
yyfunc double EpicGames_SessionSearch_CopySearchResultByIndex(double SessionIndex)
{ 
...
yyfunc double EpicGames_SessionSearch_Find(char* LocalUserId)
{ 
...
yyfunc double EpicGames_SessionSearch_GetSearchResultCount()
{ 
...
yyfunc double EpicGames_SessionSearch_Release()
{ 
	EOS_SessionSearch_Release(mOutSessionSearchHandle);
	return 0.0; 
}

yyfunc double EpicGames_SessionSearch_RemoveParameter(char* Key, double ComparisonOp)
{ 
...
yyfunc double EpicGames_SessionSearch_SetMaxResults(double MaxSearchResults)
{ 
...
yyfunc double SDKEpicGames_SessionSearch_SetParameter(double comparisonOp,char* buff_args)
{
	auto args = buffer_unpack((uint8_t*)buff_args);
	auto Attribute = YYGetStruct(args[0]);
...
yyfunc double EpicGames_SessionSearch_SetSessionId(char* SessionId)
{
...
yyfunc double EpicGames_SessionSearch_SetTargetUserId(char* TargetUserId)
{ 
