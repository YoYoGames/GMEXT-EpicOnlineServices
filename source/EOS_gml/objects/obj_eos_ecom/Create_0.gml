...
var _query_offers_callback = function(_data)
{
	...
	for(var i = 0; i < eos_ecom_get_offer_count(global.epic_account_id); i++)
	{
		...
		for(var j = 0; j < eos_ecom_get_offer_item_count(global.epic_account_id, offer.id); j++)
		{
...
eos_ecom_query_offers(global.epic_account_id, "", _query_offers_callback)
