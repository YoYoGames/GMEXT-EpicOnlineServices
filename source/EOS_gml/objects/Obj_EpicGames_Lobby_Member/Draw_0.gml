...
switch(AudioStatus)
{
	case EOS_RTC_AUDIO_STATUS.AdminDisabled: AudioStatus_txt = "AdminDisabled" break
	...
	case EOS_RTC_AUDIO_STATUS.NotListeningDisabled: AudioStatus_txt = "NotListeningDisabled" break
