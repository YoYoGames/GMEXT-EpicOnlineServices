...
{
	case "eos_p2p_add_notify_incoming_packet_queue_full":
	break
	...
	case "eos_p2p_add_notify_peer_connection_interrupted":
	break
	...
	case "eos_p2p_add_notify_peer_connection_request":
		...
		eos_p2p_send_packet(buff,buffer_tell(buff),true,false,noone,userID,true,async_load[? "remote_user_id"],socketName)
		buffer_delete(buff)
