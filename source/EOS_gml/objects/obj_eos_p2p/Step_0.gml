...
var max_loops = 5;
while(eos_p2p_get_next_received_packet_size(global.product_user_id, 0))
{
	var _packet = eos_p2p_receive_packet(global.product_user_id, buff_recv, 256, 0, 0)
	if(!_packet.ok)
		break
...
{
	var result = eos_p2p_send_packet(global.product_user_id, EstablishedProductIDs[a], socketName, 0, buff, buffer_tell(buff), true, EpicPacketReliability.ReliableOrdered, false)
