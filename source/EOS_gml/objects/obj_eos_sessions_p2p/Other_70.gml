...
switch(async_load[? "type"])
{
	case "eos_p2p_add_notify_peer_connection_closed":
		...
		if(owner)
		{
			...
			eos_sessions_unregister_players(obj_eos_sessions.SessionName,[async_load[? "remote_user_id"]])
		}
	...
	case "eos_p2p_add_notify_peer_connection_established":
		...
		if(owner)
		{
			...
			eos_sessions_register_players(obj_eos_sessions.SessionName,[async_load[? "remote_user_id"]])
		}
